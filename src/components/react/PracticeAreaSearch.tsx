                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {filteredAreas.map((area) => (
                        <a
                            ...
                            className="group flex flex-col p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-all border border-neutral-100 h-full block"
                        >
                            <div className="mb-4">
                            ...
                            <div className="mt-auto pt-4">
                                <span className="inline-flex items-center text-sm font-semibold text-[--color-primary-600] group-hover:underline">
                                    Mehr erfahren
